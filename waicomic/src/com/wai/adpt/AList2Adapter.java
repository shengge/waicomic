...
import com.wai.listener.AList2OnClick;

@SuppressWarnings({ "unchecked", "rawtypes" })
public class AList2Adapter extends BaseAdapter {
	public AList2Adapter(Context context, FinalDb fdata, FinalHttp fhttp, AjaxParams param, FinalBitmap fbmap) {
...
//				this.fhttp.post("http://ttt.k76.com/wai/page", this.param, new AjaxCallBack() {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		convertView = this.filter.inflate(R.layout.item2, null);
		...
		try {
			...
			((TextView) convertView.findViewById(R.id.text4)).setOnClickListener(new AList2OnClick(this, position, this.jsons, this.fdata));
		} catch (Exception e) {
			e.printStackTrace();
		}
